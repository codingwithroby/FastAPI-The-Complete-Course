...
BOOKS = [
    Book(1, "Computer Scipece Pro", "codingwithroby", "A very nice book!", 5, 2010),
    ...
    Book(4, "HP1", "Author 1", "Book Description 1", 2, 2015),
    Book(5, "HP2", "Author 2", "Book Description 2", 3, 2024),
    Book(6, "HP3", "Author 3", "Book Description 3", 1, 2020),
]
...
async def update_book_content(book_request: BookRequest):
    book_changed = False
